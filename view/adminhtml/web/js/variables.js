...
define([
    ...
    window.Variables = {
        ...
        insertVariable: function (variable) {
            ...
            if (textareaElm.id === "template_text") {

                if (!isNaN(variable)) {
                    variable = Variables.variablesValue[variable - 1];
                }

                let element = window.grapesjsSelectedElement;
                if (
                    element.is("text") ||
                    element.is("link")
                ) {
                    element.append("<span>" + variable + "</span>");
                } else {
                    alert("Variables should be placed inside text or links only!");
                }
            }
        }
    };
